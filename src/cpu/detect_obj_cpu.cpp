                               ...
                               int channels)
{
    ...
    int nb_components = threshold(obj, temp);
                              ...
                              int* nb_objs)
{
    ...
    for (int i = 1; i < length; i++) {
        all_boxes[i - 1] =
            object_detection(ref_image, images[i], obj_image, temp_image,
                             g_kernel, k1, k2, &nb_obj, channels);
        nb_objs[i - 1] = nb_obj;
    }
                                  ...
                                  int* nb_obj)
{
    ...
    int nb_components = threshold(obj_image, temp_image);
